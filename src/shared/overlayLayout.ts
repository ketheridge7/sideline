  ...
  switch (presetId) {
    ...
    case 'user.1':
      return layout(presetId === 'user.1' ? 'user.1' : 'broadcast-l', [
        box('col.mine.pos', 1.5, 8, 2.5, 72),
        box('col.mine.name', 4, 8, 9, 72),
        box('col.mine.nfl', 13.2, 8, 3.5, 72, { hidden: true }),
        box('col.mine.pts', 13.2, 8, 4.5, 72),
        box('score.mine', 1.5, 82, 16, 12),
        box('team.mine.name', 1.5, 94, 16, 4),
        box('score.delta', 19, 88, 10, 6),
        box('meta.week', 19, 94.5, 8, 3),
        box('meta.live', 27.5, 94.5, 6, 3),
        box('meta.league', 35, 94.5, 22, 3),
        box('toast.slot', 19, 82, 28, 6),
        box('col.opp.pts', 82.3, 8, 4.5, 72),
        box('col.opp.name', 87, 8, 9, 72),
        box('col.opp.nfl', 78.8, 8, 3.5, 72, { hidden: true }),
        box('col.opp.pos', 96.2, 8, 2.5, 72),
        box('score.opp', 82.5, 82, 16, 12),
        box('team.opp.name', 82.5, 94, 16, 4),
