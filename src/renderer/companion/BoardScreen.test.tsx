...
describe('BoardScreen ESPN UX', () => {
  ...
  it('keeps named starters when ESPN is healthy and does not paint On air chrome', () => {
    ...
    expect(html).toContain('Von Achane')
    expect(html).toContain('data-lineup-row="opp"')
    expect(html).toContain('data-hud-rail="mine"')
    expect(html).toContain('data-hud-rail="opp"')
    expect(html).toContain('data-roster-scroll')
    expect(html).toContain('data-hud-scoreboard="pin"')
    expect(html).toContain('Team Etheridge')
    expect(html).toContain('Django Achane')
    expect(html).not.toContain('YOUR TEAM')
    expect(html).not.toContain('>OPPONENT<')
    expect(html).toContain('My leagues')
    expect(html).not.toContain('data-league-chips')
    expect(html).not.toContain('On air')
